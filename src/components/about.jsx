...
const SectionHeading = ({ eyebrow, title, sub }) => (
  <div className="mb-12 text-center">
    ...
    <h2 className="mt-3 font-display text-4xl font-bold tracking-tight text-zinc-900 dark:text-white sm:text-5xl">
      {title}
    </h2>
  ...
  return (
    <section id="about" className="scroll-mt-24 py-24">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        >
          <div className="relative h-full min-h-[20rem] overflow-hidden rounded-[1.3rem]">
            <img
              src={aboutImg}
        ...
        <motion.div
          ...
          className="rounded-3xl glass p-7 md:col-span-2"
        >
          <p className="text-[15px] leading-relaxed text-zinc-700 dark:text-zinc-300">{ABOUT_TEXT}</p>
        </motion.div>
